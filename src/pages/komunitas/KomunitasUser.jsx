        ...
        <div className="content-komunitas-user-group">
          <div className="content-filter">
            <div className="card-content-filter">
              ...
              <div className="filter-komunitas-3">
                <h1>Kata kunci populer</h1>
                <div>
                  <div>
                    <Link className="badge-filter-komunitas-3">#nutrisi</Link>
                  </div>
                  <div>
                    <Link className="badge-filter-komunitas-3">#diet</Link>
                  </div>
                  <div>
                    <Link className="badge-filter-komunitas-3">#olahraga</Link>
                  </div>
                  <div>
                    <Link className="badge-filter-komunitas-3">#yoga</Link>
                  </div>
                  <div>
                    <Link className="badge-filter-komunitas-3">#resep</Link>
                  </div>
                  <div>
                    <Link className="badge-filter-komunitas-3">#sehat</Link>
                  </div>
                  <div>
                    <Link className="badge-filter-komunitas-3">#stress</Link>
                  </div>
                  <div>
                    <Link className="badge-filter-komunitas-3">#rutin</Link>
                  </div>
                  <div>
                    <Link className="badge-filter-komunitas-3">
                      #keseimbangan
                    </Link>
                  </div>
                  <div>
                    <Link className="badge-filter-komunitas-3">#mental</Link>
                  </div>
                  <div>
                    <Link className="badge-filter-komunitas-3">#makanan</Link>
                  </div>
                  <div>
                    <Link className="badge-filter-komunitas-3">#menu</Link>
                  </div>
                  <div>
                    <Link className="badge-filter-komunitas-3">#latihan</Link>
                  </div>
                  <div>
                    <Link className="badge-filter-komunitas-3">#sarapan</Link>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="content-post">
            <div className="card-create-post">
              <div className="card-body-create-post">
                <h1>Hai username Ingin buat postingan?</h1>
            ...
            <div className="post-newer">
              ...
              <div className="card-posts">
                ...
                <div className="card-footer-posts">
                  ...
                  <Link to="/detail-post" className="icon-group-footer-posts">
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
