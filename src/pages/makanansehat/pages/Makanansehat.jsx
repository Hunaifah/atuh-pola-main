        ...
        <Container className="containercontent">
          ...
          <Col>
            <h1 className="header-title">
              Ketahui Dulu Kebutuhan{" "}
              <span className="highlight">Nutrisi Harianmu!</span>
            </h1>
          ...
          <Col>
            <h1 className="header-title">Rekomendasi Menu Sehat Untuk Kamu</h1>
          </Col>
          <div
            className="row justify-content-center button-warning-gym"
            onClick={handleButtonClick}
          >
            {filterMenu.map((val) => (
              <div
                key={val.id}
                className="col-lg-3 col-md-4 col-sm-6 card my-3 border-0"
              ...
              >
                ...
                <div className="d-flex icon-container">
                  <img src={val.minyak} alt="Minyak" className="icon mx-2" />{" "}
                  430
